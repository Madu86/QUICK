...
#ifdef OSHELL
#ifdef int_spd
__device__ void iclass_oshell
#elif defined int_spdf
__device__ void iclass_oshell_spdf
#elif defined int_spdf2
__device__ void iclass_oshell_spdf2
#elif defined int_spdf3
__device__ void iclass_oshell_spdf3
#elif defined int_spdf4
__device__ void iclass_oshell_spdf4
#elif defined int_spdf5
__device__ void iclass_oshell_spdf5
#elif defined int_spdf6
__device__ void iclass_oshell_spdf6
#elif defined int_spdf7
__device__ void iclass_oshell_spdf7
#elif defined int_spdf8
__device__ void iclass_oshell_spdf8
#elif defined int_spdf9
__device__ void iclass_oshell_spdf9
#elif defined int_spdf10
__device__ void iclass_oshell_spdf10
#endif
#else
#ifdef int_spd
__device__ void iclass
#elif defined int_spdf
__device__ void iclass_spdf
#elif defined int_spdf2
__device__ void iclass_spdf2
#elif defined int_spdf3
__device__ void iclass_spdf3
#elif defined int_spdf4
__device__ void iclass_spdf4
#elif defined int_spdf5
__device__ void iclass_spdf5
#elif defined int_spdf6
__device__ void iclass_spdf6
#elif defined int_spdf7
__device__ void iclass_spdf7
#elif defined int_spdf8
__device__ void iclass_spdf8
#elif defined int_spdf9
__device__ void iclass_spdf9
#elif defined int_spdf10
__device__ void iclass_spdf10
#endif
#endif
(int I, int J, int K, int L, unsigned int II, unsigned int JJ, unsigned int KK, unsigned int LL, QUICKDouble DNMax, gpu_simulation_type *devSim)
{
                ...
                for (int LLL = MAX(KKK,LLL1); LLL <= LLL2; LLL++) {
                    ...
                    if (III < KKK ||
                        ...
                        QUICKDouble Y = (QUICKDouble) hrrwhole2
                                                               ...
                                                               RCx, RCy, RCz, RDx, RDy, RDz, devSim);
#ifdef int_spd
                        if (abs(Y) > 0.0e0)
#else
                        ...
                        {
#ifdef OSHELL
                            addint_oshell(devSim->oULL,devSim->obULL, Y, III, JJJ, KKK, LLL, (QUICKDouble)devSim->hyb_coeff, (QUICKDouble*) devSim->dense, (QUICKDouble*) devSim->denseb, devSim->nbasis);
#else
                            addint(devSim->oULL, Y, III, JJJ, KKK, LLL, devSim->hyb_coeff, (QUICKDouble*) devSim->dense, devSim->nbasis);
#endif
                        }
